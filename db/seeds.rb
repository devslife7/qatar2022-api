...
users = [
  ...
  },
  {
    first_name: "Hector",
    last_name: "Domiguez",
    predictionsGS: ["A1", "B1", "A3", "B4", "C1", "D3", "C4", "D1", "F4", "E3", "E1", "F1", "G4", "H3", "H1", "G1", "B4", "A3", "A4", "B1", "D4", "C4", "D1", "C1", "E4", "F1", "F4", "E1", "G4", "H2", "G1", "H3", "A3", "A4", "B1", "B3", "D3", "D1", "C1", "C3", "F2", "F1", "E3", "E1", "H3", "H1", "G1", "G2"],
  },
]
